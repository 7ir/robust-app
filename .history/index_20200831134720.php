		...
		<div id="view__quiz-1" class="view">
			...
			<div id="wrap">
				...
				<div class="layer-2-wrap">
					<div class="layer-2" id="1"><img src="./img/icons/icon-1.png"/></div>
					<div class="layer-2-b" id="1"><img src="./img/icons/icon-1-b.png"/></div>

					<div class="layer-2" id="2"><img src="./img/icons/icon-2.png"/></div>
					<div class="layer-2-b" id="2"><img src="./img/icons/icon-2-b.png"/></div>

					<div class="layer-2" id="3"><img src="./img/icons/icon-3.png"/></div>
					<div class="layer-2-b" id="3"><img src="./img/icons/icon-3-b.png"/></div>

					<div class="layer-2" id="4"><img src="./img/icons/icon-4.png"/></div>
					<div class="layer-2-b" id="4"><img src="./img/icons/icon-4-b.png"/></div>
				</div>
			</div>
