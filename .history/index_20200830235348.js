...
function switchViewMode() {
    ...
    if (checkBox.checked == true){
        ...
        document.querySelectorAll(".p").style.background = "white";
        document.querySelector(".rotated-text").style.background = "white";
        document.querySelector(".rotated-text").style.color = "black";
        document.querySelectorAll(".title").style.background = "white";
        document.querySelectorAll(".title").style.color = "black";
        document.querySelectorAll(".intro-title").style.background = "white";
        document.querySelectorAll(".intro-title").style.color = "black";
