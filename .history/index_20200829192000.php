...
<div class="main">
	...
	<div id="view-wrap-id" class="view-wrap">
		...
		<div id="view__quiz-4" class="view">
			...
			<div>
				<div class="symbol" id="1"><img class="mmIcon" src="./img/icons/icon-1.svg"/></div>
				<div class="symbol" id="2"><img class="mmIcon" src="./img/icons/icon-1.svg"/></div>
				<div class="symbol" id="3"><img class="mmIcon" src="./img/icons/icon-1.svg"/></div>
				<div class="symbol" id="4"><img class="mmIcon" src="./img/icons/icon-1.svg"/></div>
			</div>
			<?php include('backButton.php'); ?>
		</div>
