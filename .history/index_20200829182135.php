	...
	<div id="view-wrap-id" class="view-wrap">
		...
		<div id="view__quiz-3" class="view">
			<div class="">
					...
					<input type="text" name="agent1" id="agent1">
					<button class="button" onclick="checkForm();"><img style="width:100%;height:100%;" src="./img/noolparemale.svg"/></button>
		...
		<!-- Award -->
		<div id="view__quiz-5" class="view">
