                ...
                if(!i.disabled){
                    ...
                    if(p.length>0){
                        ...
                        if(o.lastPosObj)
                            ...
                            b=Math.abs(u.i-g),y=Math.abs(u.j-x);0===b&&y>1||0===y&&b>1||y==b&&y>1;){g=b?g+j:g,x=y?x+w:x,b=Math.abs(u.i-g),y=Math.abs(u.j-x);
