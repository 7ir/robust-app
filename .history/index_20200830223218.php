...
<div class="main" id="main-id">
	<div class="sidebar">
		<div class="sidebar-row-1">
			<p class="sidebar-text">Switch to ligh mode: </p>
			<label class="switch">
	...
	<div id="view-wrap-id" class="view-wrap">
		...
		<div id="view__quiz-1" class="view">
			<h1 class="title">CONNECT ICONS IN ORDER</h1><p class="p" >Here is a random array I generated for you:</p>
			<div id="wrap">
				<div id="layer-1-wrap">
					<div id="layer-1">
			...
			<div>
				<div class="title">MATH QUIZ</div>
					<div class="content-wrap">
						...
						<button class="button-footer" id="quiz-4-btn" onclick="checkForm();">CHECK ANSWER</button>
					</div>
			</div>
			<?php include('backButton.php'); ?>
		</div>
		...
		<div class="view" id="yes" style="background:rgba( 110, 177, 0, 0.98);display:none;"></div>
		<div class="view" id="no" style="background:rgba(224,46,0,0.95);display:none;"></div>
    </div>
</div>
</body> 
