...
function switchViewMode() {
    ...
    if (checkBox.checked == true){
        ...
        document.getElementsByClassName("rotated-text").style.background = "white";
        document.getElementsByClassName("rotated-text").style.color = "black";
        document.getElementsByClassName("title").style.background = "white";
        document.getElementsByClassName("title").style.color = "black";
        document.getElementsByClassName("intro-title").style.background = "white";
        document.getElementsByClassName("intro-title").style.color = "black";
