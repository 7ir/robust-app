...
function switchViewMode() {
    ...
    if (checkBox.checked == true){
        ...
        document.getElementsByClassName("main").background = "whitesmoke !important";
    } else {
        console.log('switched to desktop view')
        document.getElementsByClassName("main").background = "#111 !important";
    }
};
    ...
    var something = (function() {
        ...
        return function() {
            if (!executed) {
                ...
                // do something
                PatternlockGame();
                console.log('mangonce f worked but ..');
            }
        };
    })();
    something();
