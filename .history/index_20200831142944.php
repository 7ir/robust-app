			...
			<div id="wrap">
				<div id="layer-1-wrap">
					<div id="layer-1">
						...
						<div id="layer-1-icon-b-id-11" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-1-b.png"/>
						</div>

						<div id="layer-1-icon-id-2"></div>
						<div id="layer-1-icon-b-id-22" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-2-b.png"/>
						</div>

						<div id="layer-1-icon-id-3"></div>
						<div id="layer-1-icon-b-id-33" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-3-b.png"/>
						</div>

						<div id="layer-1-icon-id-4"></div>
						<div id="layer-1-icon-b-id-44" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
