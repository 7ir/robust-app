...
<div class="main" id="main-id">
	...
	<div id="view-wrap-id" class="view-wrap">
		...
		<div id="view__quiz-1" class="view">
			...
			<div class="invert" style="	width: 100%;
	height: 100%;
	pointer-events: none;
	...
	pointer-events: none;
	z-index: 999;
	-webkit-backdrop-filter: invert(1)"></div>
			<div id="wrap">
				<div id="layer-1-wrap">
					<div id="layer-1">
						<div id="layer-1-icon-id-1"></div>
						<div id="layer-11-icon-b-id-1" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-1-b.png"/>
						</div>

						<div id="layer-1-icon-id-2"></div>
						<div id="layer-11-icon-b-id-2" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-2-b.png"/>
						</div>

						<div id="layer-1-icon-id-3"></div>
						<div id="layer-11-icon-b-id-3" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-3-b.png"/>
						</div>

						<div id="layer-1-icon-id-4"></div>
						<div id="layer-11-icon-b-id-4" style="display: none;margin: 40px;width: 80px;height: 80px;float: left;position: relative;">
							<img class="layer-2-icon" style="display:none;" src="./img/icons/icon-4-b.png"/>
						</div>
				...
				<div class="layer-2-wrap">
					...
					<div class="layer-2-b" id="11" style="display:none;"></div>

					<div class="layer-2" id="2"><img class="layer-2-icon" src="./img/icons/icon-2.png"/></div>
					<div class="layer-2-b" id="22" style="display:none;"></div>
					<!-- <div class="layer-2-b" id="22"><img class="layer-2-icon-b" src="./img/icons/icon-2-b.png"/></div> -->

					<div class="layer-2" id="3"><img class="layer-2-icon" src="./img/icons/icon-3.png"/></div>
					<div class="layer-2-b" id="33" style="display:none;"></div>
					<!-- <div class="layer-2-b" id="33"><img class="layer-2-icon-b" src="./img/icons/icon-3-b.png"/></div> -->

					<div class="layer-2" id="4"><img class="layer-2-icon" src="./img/icons/icon-4.png"/></div>
					<div class="layer-2-b" id="44" style="display:none;"></div>
					<!-- <div class="layer-2-b" id="44"><img class="layer-2-icon-b" src="./img/icons/icon-4-b.png"/></div> -->
				</div>
			</div>
