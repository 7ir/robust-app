	...
	<div class="sidebar">
		<div class="sidebar-row-1">
			<!-- <div class="sidebar-row-1-wrap"> -->
				<p class="sidebar-text">Toggle color mode: </p>
				<label class="switch">
	...
	<div id="view-wrap-id" class="view-wrap">
		...
		<div id="view__quiz-4" class="view">
			...
			<div class="layer-2">
				...
				<div class="layer-2" id="3"><img class="layer-2-icon" src="./img/icons/icon-1.png"/></div>
				<div class="layer-2" id="4"><img class="layer-2-icon" src="./img/icons/icon-1.png"/></div>
			</div>
			<?php include('backButton.php'); ?>
		</div>
