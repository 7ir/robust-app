...
function switchViewMode() {
    ...
    if (checkBox.checked == true){
        ...
        document.querySelector("p").color = "black";
        document.querySelector(".p").background = "white";
        document.getElementById("rotated-text").style.background = "white";
        document.querySelector("#rotated-text").color = "black";
        document.querySelector(".title").background = "white";
        document.querySelector(".title").color = "black";
