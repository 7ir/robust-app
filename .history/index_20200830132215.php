...
<!-- 					<p>Resize the browser window to fire the <code>resize</code> event.</p>
		...
		<div id="view__quiz-1" class="view">
			<div id="wrap">
				...
				<div>
					<div class="layer-2" id="1"><img class="layer-2-icon" src="./img/icons/icon-4.png"/></div>
					<div class="layer-2" id="2"><img class="layer-2-icon" src="./img/icons/icon-1.png"/></div>
					<div class="layer-2" id="3"><img class="layer-2-icon" src="./img/icons/icon-2.png"/></div>
					<div class="layer-2" id="4"><img class="layer-2-icon" src="./img/icons/icon-3.png"/></div>
				</div>
			</div>
		...
		<!-- Quiz 4 view, LocalStorage math quiz/test -->
