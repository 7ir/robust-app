	...
	<div id="view-wrap-id" class="view-wrap">
		...
		<div id="view__map" class="view">
            <div class="container">
				...
				<button class="card__quiz" id="button-footer-2" onclick="toAward()" disabled>AWARD
				</button>
			</div>
		</div>
		...
		<div id="view__quiz-1" class="view">
			<h1 class="title">CONNECT ICONS IN ORDER</h1><p>Please, I generated a random array for you:</p>
			<div id="wrap">
				<div id="layer-1-wrap">
					<div id="layer-1">
