...
function switchViewMode() {
    ...
    if (checkBox.checked == true){
        ...
        document.querySelectorAll('#layer-11-icon-b-id-1').forEach(el => {
            el.style.display = "block";
        })
        ...
        document.querySelectorAll('#layer-11-icon-b-id-2').forEach(el => {
            el.style.display = "block";
        })
        document.querySelectorAll('#layer-1-icon-id-3').forEach(el => {
            el.style.display = "none";
        }) 
        document.querySelectorAll('#layer-11-icon-b-id-3').forEach(el => {
            el.style.display = "block";
        })
        document.querySelectorAll('#layer-1-icon-id-4').forEach(el => {
            el.style.display = "none";
        }) 
        document.querySelectorAll('#layer-11-icon-b-id-4').forEach(el => {
            el.style.display = "block";
        })
