...
function checkForm() {
    ...
    var myArray = ['lõug', 'lõualuu', 'luu', 'loualuu', 'haugi lõualuu','kont','hambad','hammas','cheekbone','bone','teeth','cheek','pike mandible','mandible','pike','Lõug', 'Lõualuu', 'Haugi lõualuu', 'Luu','Kont','Hambad','Hammas','Cheekbone','Bone','Teeth','Cheek','Pike mandible','Mandible','Pike'];
    if(myArray.indexOf(agent1) == -1) //returns the index of the selected element 
    {
		$('#no').show();
		setTimeout(function () {
			$('#no').hide();
