...
function switchViewMode() {
    ...
    if (checkBox.checked == true){
        ...
        document.querySelectorAll('#layer-1-icon-id-1').forEach(el => {
            el.style.display = "none";
        }) 
        document.querySelectorAll('#layer-1-icon-b-id-11').forEach(el => {
            el.style.display = "block";
        })

        document.querySelectorAll('#layer-1-icon-id-2').forEach(el => {
            el.style.display = "none";
        }) 
        document.querySelectorAll('#layer-1-icon-b-id-22').forEach(el => {
            el.style.display = "block";
        })
        document.querySelectorAll('#layer-1-icon-id-3').forEach(el => {
            el.style.display = "none";
        }) 
        document.querySelectorAll('#layer-1-icon-b-id-33').forEach(el => {
            el.style.display = "block";
        })
        document.querySelectorAll('#layer-1-icon-id-4').forEach(el => {
            el.style.display = "none";
        }) 
        document.querySelectorAll('#layer-1-icon-b-id-44').forEach(el => {
            el.style.display = "block";
        })
       
        $( '#layer-1-icon-b-id-' + arr2[0] ).append( $('#11') );
        $( '#layer-1-icon-b-id-' + arr2[1] ).append( $('#22') );
        $( '#layer-1-icon-b-id-' + arr2[2] ).append( $('#33') );
        $( '#layer-1-icon-b-id-' + arr2[3] ).append( $('#44') );
        
        document.querySelectorAll('.layer-2-b').forEach(el => {
            el.style.display = "block";
        }) 
        document.querySelectorAll('.layer-2-icon').forEach(el => {
            el.style.display = "block";
        })
